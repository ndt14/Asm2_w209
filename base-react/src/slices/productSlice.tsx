// import { addProduct, deleteProduct, detailProduct, fetchProducts, updateProduct } from '../actions/product';
...
//             state.products = state.products.find((item) => item.id === productId) || null;
//         })
//     }
// })
